...
return [
     ...
     * CONFIG__DEFAULT__PAYMENT__STRIPE_PAYMENTS_BASIC__STRIPE_TEST_SK for payment/stripe_payments_basic/stripe_test_sk
     * CONFIG__DEFAULT__PAYMENT__STRIPE_PAYMENTS_BASIC__STRIPE_LIVE_SK for payment/stripe_payments_basic/stripe_live_sk
        ...
        'default' => [
            ...
            'payment' => [
                ...
                'stripe_payments' => [
                    ...
                    'payment_flow' => '0',
                    'payments' => [
                        'preview_embedded_payment_flow' => null,
                        'preview_redirect_payment_flow' => null,
                        'payment_method_configuration' => null,
                    ],
                    'payment_element_layout' => '0',
                    'title' => 'Pay online',
                    'payment_action' => 'authorize_capture',
                    'expired_authorizations' => null,
                    'automatic_invoicing' => null,
                    'save_payment_method' => '0',
                    'cvc_code' => 'new_cards',
                    'card_icons' => '0',
                    'card_icons_specific' => 'amex,discover,diners,jcb,mastercard,visa,cartes_bancaires',
                    'statement_descriptor' => null,
                    'radar_risk_level' => '10',
                    'model' => 'StripePaymentsFacade',
                    'stripe_test_sk' => null,
                    'stripe_live_sk' => null,
                    'currency' => 'USD',
                    'sort_order' => '1',
                    'card_autodetect' => '2',
                    'cctypes' => 'visa,mastercard,amex,jcb,discover,diners,cartes_bancaires',
                    'level3_data' => '0',
                    'webhook_origin_check' => '1',
                    'is_gateway' => '1',
                    'can_authorize' => '1',
                    'can_capture' => '1',
                    'can_capture_partial' => '1',
                ...
                'stripe_payments_basic' => [
                    'stripe_mode' => 'test',
                    'stripe_test_pk' => 'pk_test_51O0nGfKUXnP0ANqY5OrADncfiNmJmuKsIyzLGibicaMEpdLQGF9d7OXtnfcFtFriTUy4BveVE8K2pkATTgMQHi4X00bjYs7ps7',
                    'stripe_live_pk' => null,
                ],
                'stripe_payments_checkout' => [
                    'sort_order' => null,
                    'active' => '1',
                    'model' => 'StripeIntegration\\Payments\\Model\\Method\\Checkout',
                ...
                'stripe_payments_bank_transfers' => [
                    ...
                    'model' => 'StripeIntegration\\Payments\\Model\\Method\\BankTransfers',
                    'can_use_internal' => '0',
                    'can_use_checkout' => '1',
                    'can_use_for_multishipping' => '0',
                    'can_refund' => '1',
                ...
                'stripe_payments_express' => [
                    'global_enabled' => '1',
                    'enabled' => 'product_page,minicart,shopping_cart_page,checkout_page',
                    'button_type' => 'default',
                    'button_theme' => 'dark',
                    'button_height' => '50',
                    'seller_name' => null,
                    'model' => 'StripeExpressFacade',
                    'title' => 'Wallet payment via Stripe',
                    'is_gateway' => '1',
                    'can_authorize' => '1',
                    'can_capture' => '1',
                    'can_capture_partial' => '1',
                ...
                'stripe_payments_subscriptions' => [
                    'active' => '1',
                    'upgrade_downgrade' => '1',
                    'prorations_upgrades' => '0',
                    'prorations_downgrades' => '0',
                    'additional_info' => '1',
                    'model' => 'StripeSubscriptionsFacade',
                ],
                'free' => [
                ...
                'stripe_payments_invoice' => [
                    'active' => '1',
                    'model' => 'StripePaymentsInvoiceFacade',
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'S1EHAExL2azk1WVHWnz3VDpQ4vn3VZstNLShau5vxL2XxVByZHaycXvaoAKQwSIp',
                ],
                'authy' => [
            ...
            'system' => [
                'cron' => [
                    ...
                    'stripe_payments' => [
                        'schedule_generate_every' => '1',
                        'schedule_ahead_for' => '1440',
                        'schedule_lifetime' => '70',
                        'history_cleanup_every' => '10',
                        'history_success_lifetime' => '60',
                        'history_failure_lifetime' => '600',
                        'use_separate_process' => '1',
...
Disallow: /*SID=
            ...
            'stripe_settings' => [
                'automatic_webhooks_configuration' => '1',
                'payment_method_configuration' => '0',
