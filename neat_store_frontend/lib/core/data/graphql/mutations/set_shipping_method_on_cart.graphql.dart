...
class Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices {
    ...
    return Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices(
      subtotal_with_discount_excluding_tax:
          l$subtotal_with_discount_excluding_tax == null
              ? null
              : Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax
  ...
  final Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax?
      subtotal_with_discount_excluding_tax;
...
abstract class CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices<
  ...
  CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
      ...
      _then(
        ...
        subtotal_with_discount_excluding_tax:
            subtotal_with_discount_excluding_tax == _undefined
                ...
                : (subtotal_with_discount_excluding_tax
                    as Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax?),
...
class Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax {
  Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax({
    this.currency,
    this.value,
  ...
  factory Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax.fromJson(
      Map<String, dynamic> json) {
    final l$currency = json['currency'];
    final l$value = json['value'];
    final l$$__typename = json['__typename'];
    return Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax(
  ...
  bool operator ==(Object other) {
    ...
    if (!(other
            is Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$currency = currency;
...
extension UtilityExtension$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax
    on Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax {
  CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
          Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax>
      get copyWith =>
          CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax(
...
abstract class CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
    TRes> {
  factory CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax(
    Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax
        instance,
    TRes Function(
            Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax)
        then,
  ) = _CopyWithImpl$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax;

  factory CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax.stub(
          TRes res) =
      _CopyWithStubImpl$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax;
...
class _CopyWithImpl$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
        TRes>
    implements
        CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
            TRes> {
...
class _CopyWithStubImpl$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
        TRes>
    implements
        CopyWith$Mutation$SetShippingMethodsOnCart$setShippingMethodsOnCart$cart$prices$subtotal_with_discount_excluding_tax<
            TRes> {
